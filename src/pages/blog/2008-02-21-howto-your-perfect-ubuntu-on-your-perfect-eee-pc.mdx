...
author: rami
categories: Blog bout: linuxologist
publishedAt: '2008-02-21'
summary: Now that you [installed Ubuntu](/2008/02/11/howto-install-ubuntu-on-your-eee-pc)
  on your Eee PC, you will soon realize that something is amiss. Wireless doesn't
  work, shutdown almost never works, the whole desktop seems to be cramped onto a
  small screen...etc. Now it's time to perfect our Ubuntu.
tags:
- eee-pc
- ubuntu
- howto
