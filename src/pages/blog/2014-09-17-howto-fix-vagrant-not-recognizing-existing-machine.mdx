...
image: vagrant.jpg
excerpt: "I've been using vagrant as a cornerstone of my development environment for a while now. This morning I booted up my machine, and tried to cd into my working directory only to be greeted with this error: 'bash: cd: projects: No such file or directory"
publishedAt: '2014-09-17'
tags:
- dev
- vagrant
url: blog
